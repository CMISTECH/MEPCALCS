...
@Component({
  selector: 'app-circulation-pump-head',
  templateUrl: './circulation-pump-head.component.html',
  styleUrls: ['./circulation-pump-head.component.scss']
})
export class CirculationPumpHeadComponent implements OnInit {
  isLoading = true;
  isSubmitting = false;
  isSubmitted = false;
  showResult = false;
  ...
  onSubmit() {
    ...
    this.apiService.calculateCPHead(body).subscribe((res: any) => {
