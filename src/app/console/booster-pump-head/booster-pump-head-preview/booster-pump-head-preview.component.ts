...
@Component({
  selector: 'app-booster-pump-head-preview',
  templateUrl: './booster-pump-head-preview.component.html',
  styleUrls: ['./booster-pump-head-preview.component.scss']
})
export class BoosterPumpHeadPreviewComponent implements OnInit {
  @Input() data: any = [];
  ...
  generatePDF() {
    var docDefinition: any = {
      ...
      header: {
        ...
        table: {
          ...
          body: [
            [
              {
                text: 'BOOSTER PUMP HEAD CALCULATOR',
                style: 'mainHeader'
              }
            ],
            [
      ...
      content: [
        ...
        // 5. Static Head & Residual Pressure
        {
          unbreakable: true,
          layout: 'noBorders',
          table: {
            ...
            body: [
              [
                {
                  text: '5. Static Head & Residual Pressure',
                  style: 'sectionHeader'
                }
              ],
              [
                {
                  table: {
                    ...
                    body: [
                      [
                        { text: 'Static Head' }, { text: this.getValue(this.data.o33) + ' ' + this.getValue(this.data.tx6), bold: true },
                        { text: 'Residual Pressure At Point Of Use' }, { text: this.getValue(this.data.o34) + ' ' + this.getValue(this.data.tx7), bold: true }
                      ]
                    ]
                  }
                }
